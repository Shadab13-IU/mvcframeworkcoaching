...
public class FrontController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String path=request.getPathInfo().substring(1).trim();
            out.println(path);
            Properties pr=new Properties();
            pr.load(new FileInputStream("/home/shadab/NetBeansProjects/mvcframework/src/java/controller/info.properties"));
            
            String pf=pr.getProperty(path);
            String str=pf.substring(pf.length()-3);
            //String[] value=pf.split("\\.");
            if(str.equals("jsp")){
               // out.println(pf);
                request.getRequestDispatcher(pf).include(request, response);
            }else{
               out.println(pf); 
